        ...
        <div className="hidden lg:block relative z-10 px-4  absolute insert-0 bg-black opacity-70f">
          <div className="lg:max-w-lg lg:mx-auto lg:w-full">
            ...
            <div className="space-y-4">
              ...
              <Link href="/sign-up">
              <button className="w-full mt-5 bg-white hover:bg-whute/10 text-black cursor-pointer font-bold py-5 px-8 rounded-xl transition-all duration-300 text-xl shadow-lg hover:shadow-xl transform hover:scale-[1.02]">
                Sign Up
              </button>
              </Link>
            </div>
