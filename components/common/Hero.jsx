...
export default function StreamVerseHeroBanner({ 
  ...
  return (
    <div className="relative w-full max-w-2xl mx-auto mt-30 mb-8 px-4">
      ...
      <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 p-1">
        {/* Content Container */}
        <div className="relative rounded-3xl overflow-hidden bg-black/20 backdrop-blur-sm shadow-lg">
          {/* Background Image */}
          <div className="relative h-64 sm:h-80 lg:h-96 w-full">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-6 sm:px-8 lg:px-12">
              {/* Title */}
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-red-600 to-red-600 mb-2 sm:mb-4 drop-shadow-2xl">
                {title}
              </h1>
